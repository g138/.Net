<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin_requisition_approved.aspx.cs" Inherits="admin_requisition_update" %>
    ...
    <div>
        ...
        <table class="style1">
            ...
            <tr>
                <td>
                    &nbsp;</td>
                <td>
                    <asp:Label ID="Label2" runat="server" Text="Approved Requisitions" 
        ...
        AutoGenerateColumns="False" onrowdeleting="GridView1_RowDeleting" >
                    <Columns>
                     ...
                     <asp:TemplateField HeaderText="ORDER GENERATED BY">
                        <ItemTemplate>
